...
class SimpleBezier2Painter extends CustomPainter {
  ...
  SimpleBezier2Painter({this.repaint}) : super(repaint: repaint);
  List<Offset> pos;
  ...
  @override
  bool shouldRepaint(covariant SimpleBezier2Painter oldDelegate) {
